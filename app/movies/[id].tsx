...
const MovieDetails = () => {
  ...
  return (
    <View className="bg-primary flex-1">
        ...
        <TouchableOpacity className="absolute bottom-5 left-0 right-0 mx-5 bg-accent rounded-lg py3.5 flex flex-row items-center justify-center z-50" onPress={router.back}>
