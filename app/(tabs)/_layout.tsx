    ...
    if(focused){
        ...
        return (
            <View className="size-full justify-center items-center mt-4 rounded-full">
                <Image source={icon} tintColor="#ABB5D8" className="size-5"/>
...
const _layout = () => {
  return (
   <Tabs
screenOptions={{tabBarShowLabel: false, tabBarItemStyle: {width: '100%', height: '100%',justifyContent: 'center', alignItems: 'center'}, tabBarStyle: {
   ...
   >
    <Tabs.Screen name="index" options={{title: 'Home',headerShown: false,tabBarLabel: () => null,
        tabBarIcon: ({focused})=>(
            <>
