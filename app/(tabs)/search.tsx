...
const Search = () => {
  ...
  return (
    <View className="flex-1 bg-primary">
     ...
     <FlatList data={movies} renderItem={({item})=><MovieCard {...item}/>} keyExtractor={(item)=>item.id.toString()} className="px-5" numColumns={3} columnWrapperStyle={{
     ...
     ListHeaderComponent={
        ...
        <View className="my-5">
            <SearchBar onPress={()=>{}} placeholder="Search movies..." value={searchQuery} onChangeText={(text:string)=>setSearchQuery(text)}/>
